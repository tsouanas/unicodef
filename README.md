...
### for macOS
1. Install [Karabiner-Elements] and configure:<br/>
   Simple Modifications › For all devices › `right_command → non_us_backslash`.<br/>
   (`right_command` is under «Modifier keys» and `non_us_backslash` is under «Controls and symbols»).<br/>
